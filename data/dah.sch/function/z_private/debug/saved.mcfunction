...
execute if data storage dah.sch:task stash[0].rotation run tellraw @a ["",{text: " - Position: ",color: "green"},"Approx.(",{score: {name: "x",objective: "dah.sch.ram"}}," ",{score: {name: "y",objective: "dah.sch.ram"}}," ",{score: {name: "z",objective: "dah.sch.ram"}},")  ",{text:"View Coords",color: "aqua",underlined: true,"hover_event": {"action": "show_text","value": {nbt:"stash[0].position",storage: "dah.sch:task",color: "white"}}}]
execute if data storage dah.sch:task stash[0].rotation run tellraw @a ["",{text: " - Rotation: ",color: "green"},{nbt:"stash[0].rotation",storage: "dah.sch:task",color: "yellow"}]
