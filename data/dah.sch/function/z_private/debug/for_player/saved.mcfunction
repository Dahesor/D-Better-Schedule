...
execute if data storage dah.sch:task this.rotation run tellraw @a ["",{"text": " - Position: ","color": "green"},"Approx.(",{"score": {"name": "x","objective": "dah.sch.ram"}}," ",{"score": {"name": "y","objective": "dah.sch.ram"}}," ",{"score": {"name": "z","objective": "dah.sch.ram"}},")  ",{"text":"View Coords","color": "aqua","underlined": true,"hover_event": {"action": "show_text","value": {"nbt":"this.position","storage": "dah.sch:task","color": "white"}}}]
execute if data storage dah.sch:task this.rotation run tellraw @a ["",{"text": " - Rotation: ","color": "green"},{"nbt":"this.rotation","storage": "dah.sch:task","color": "yellow"}]
