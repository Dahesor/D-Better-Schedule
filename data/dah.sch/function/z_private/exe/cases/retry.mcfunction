...
execute if data storage dah.sch:task this.debug run tellraw @a {text:"[dah.sch DEBUG] ",color:"dark_aqua",extra:[{text:"Retrying in 1 tick",color:"red"}," (",{score:{name:"#retry",objective:"dah.sch.ram"},color:"yellow"}," left)"]}
